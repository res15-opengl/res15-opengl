...
void ofApp::draw()
{
    ...
    if ( false )
    {
        ...
        m_vignetteShader.setUniformTexture( "uTexture", m_texture, 0 );
        m_vignetteShader.setUniform2f( "uTexelSize", inverseResolution );
    ...
    if ( false )
    {
        ...
        m_blurShader.setUniform2f( "uTexelSize", inverseResolution );
        m_blurShader.setUniform1f( "uBlurRadius", m_blurRadius );
    ...
    if ( false )
    {
        ...
        m_filmGrainShader.setUniform1f( "uTime", ofGetElapsedTimef() * 0.05 );
